export const faqData: { question: string; answer: string }[] = [
  ...
  },
  {
    ...
    answer: `all items are final sale, except in the case of damaged or defective goods. 
      please send us an email at bork@corgowaffles.com if there are any issues.`,
  },
];
